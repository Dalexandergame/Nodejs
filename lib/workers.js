...
// Lookup all checks, get their dates, send to a validator
...
workers.validateCheckData = function(originalCheckData){
    ...
    // If all the checks pass, pass the data along in the next step in the process
...
workers.log = function(originalCheckData,checkOutcome,state,alertWarranted,timeOfCheck){
    ...
    // Append the logged string to the file
